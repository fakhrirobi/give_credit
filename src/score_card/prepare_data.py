...
from src.score_card.cleaning_data import wrangling_data 
...
BASE_CONFIG_YML_PATH = os.path.join(ROOT_DIR,"src","experiment_config")
...
def build_data(
    ...
    try:
        ...
        feature_engineered_data = feature_engineering(
            data=wrangled_data,training_req=training_req
        )
